...
public:
	...
	/// \brief 返回开始时发生
	virtual bool OnResponse(const GsStlMap<GsString,GsString>& header,GsHttpStatus status) = 0;
...
protected:
	...
	GsString	 m_Method;
	/// \brief http请求头。
	GsStlMap<GsString,GsString> m_Headers;
public:
	/// \brief 构造
	GsHttpClient();

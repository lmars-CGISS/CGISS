#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CQuantityExtentType
#define _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CQuantityExtentType
...
class CQuantityExtentType : public TypeBase
{
public:
	gie_EXPORT CQuantityExtentType(xercesc::DOMNode* const& init);
	gie_EXPORT CQuantityExtentType(CQuantityExtentType const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CQuantityExtentType

#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CBSplineType
#define _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CBSplineType
...
class CBSplineType : public ::gie::gml::CAbstractCurveSegmentType
{
public:
	gie_EXPORT CBSplineType(xercesc::DOMNode* const& init);
	gie_EXPORT CBSplineType(CBSplineType const& init);
	...
	MemberAttribute<string_type,_altova_mi_gml_altova_CBSplineType_altova_interpolation, 0, 11> interpolation;	// interpolation CCurveInterpolationType

	MemberAttribute<bool,_altova_mi_gml_altova_CBSplineType_altova_isPolynomial, 0, 0> isPolynomial;	// isPolynomial Cboolean
	MemberAttribute<string_type,_altova_mi_gml_altova_CBSplineType_altova_knotType, 0, 3> knotType;	// knotType CKnotTypesType
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CBSplineType

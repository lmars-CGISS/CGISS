#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CNilReasonTypeType
#define _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CNilReasonTypeType
...
class CNilReasonTypeType : public TypeBase
{
public:
	gie_EXPORT CNilReasonTypeType(xercesc::DOMNode* const& init);
	gie_EXPORT CNilReasonTypeType(CNilReasonTypeType const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CNilReasonTypeType

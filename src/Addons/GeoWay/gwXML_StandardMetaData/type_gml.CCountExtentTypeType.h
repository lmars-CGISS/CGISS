#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CCountExtentTypeType
#define _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CCountExtentTypeType
...
class CCountExtentTypeType : public TypeBase
{
public:
	gie_EXPORT CCountExtentTypeType(xercesc::DOMNode* const& init);
	gie_EXPORT CCountExtentTypeType(CCountExtentTypeType const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CCountExtentTypeType

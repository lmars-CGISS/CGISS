#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_Cinteger
#define _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_Cinteger
...
{
public:
	gie_EXPORT Cinteger(xercesc::DOMNode* const& init);
	gie_EXPORT Cinteger(Cinteger const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_Cinteger

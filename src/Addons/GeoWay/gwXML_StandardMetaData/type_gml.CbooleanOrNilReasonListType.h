#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CbooleanOrNilReasonListType
#define _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CbooleanOrNilReasonListType
...
class CbooleanOrNilReasonListType : public TypeBase
{
public:
	gie_EXPORT CbooleanOrNilReasonListType(xercesc::DOMNode* const& init);
	gie_EXPORT CbooleanOrNilReasonListType(CbooleanOrNilReasonListType const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CbooleanOrNilReasonListType

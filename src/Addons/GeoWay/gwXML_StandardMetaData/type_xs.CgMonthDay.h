#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CgMonthDay
#define _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CgMonthDay
...
{
public:
	gie_EXPORT CgMonthDay(xercesc::DOMNode* const& init);
	gie_EXPORT CgMonthDay(CgMonthDay const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CgMonthDay

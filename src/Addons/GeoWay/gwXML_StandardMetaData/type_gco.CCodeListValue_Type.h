#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gco_ALTOVA_CCodeListValue_Type
#define _ALTOVA_INCLUDED_gie_ALTOVA_gco_ALTOVA_CCodeListValue_Type
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gco_ALTOVA_CCodeListValue_Type

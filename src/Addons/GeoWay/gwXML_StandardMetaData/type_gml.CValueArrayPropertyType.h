#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CValueArrayPropertyType
#define _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CValueArrayPropertyType
...
class CValueArrayPropertyType : public TypeBase
{
public:
	gie_EXPORT CValueArrayPropertyType(xercesc::DOMNode* const& init);
	gie_EXPORT CValueArrayPropertyType(CValueArrayPropertyType const& init);
	...
	MemberElement<gie2::CBooleanType, _altova_mi_gml_altova_CValueArrayPropertyType_altova_Boolean> Boolean;
	...
	MemberElement<gie2::CCategoryType, _altova_mi_gml_altova_CValueArrayPropertyType_altova_Category> Category;
	...
	MemberElement<gie2::CCountType, _altova_mi_gml_altova_CValueArrayPropertyType_altova_Count> Count;
	...
	MemberElement<gie2::CQuantityType, _altova_mi_gml_altova_CValueArrayPropertyType_altova_Quantity> Quantity;
	...
	MemberElement<gml::CPolyhedralSurfaceType, _altova_mi_gml_altova_CValueArrayPropertyType_altova_PolyhedralSurface> PolyhedralSurface;
	...
	MemberElement<gml::CTriangulatedSurfaceType, _altova_mi_gml_altova_CValueArrayPropertyType_altova_TriangulatedSurface> TriangulatedSurface;
	struct TriangulatedSurface { typedef Iterator<gml::CTriangulatedSurfaceType> iterator; };
	MemberElement<gcv::CTM_GeometricPrimitive_Type, _altova_mi_gml_altova_CValueArrayPropertyType_altova_TM_GeometricPrimitive> TM_GeometricPrimitive;
	struct TM_GeometricPrimitive { typedef Iterator<gcv::CTM_GeometricPrimitive_Type> iterator; };
	MemberElement<gcv::CTM_Period_Type, _altova_mi_gml_altova_CValueArrayPropertyType_altova_TM_Period> TM_Period;
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gml_ALTOVA_CValueArrayPropertyType

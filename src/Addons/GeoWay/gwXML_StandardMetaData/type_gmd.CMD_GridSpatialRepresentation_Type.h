#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_gmd_ALTOVA_CMD_GridSpatialRepresentation_Type
#define _ALTOVA_INCLUDED_gie_ALTOVA_gmd_ALTOVA_CMD_GridSpatialRepresentation_Type
...
class CMD_GridSpatialRepresentation_Type : public ::gie::gmd::CAbstractMD_SpatialRepresentation_Type
{
public:
	gie_EXPORT CMD_GridSpatialRepresentation_Type(xercesc::DOMNode* const& init);
	gie_EXPORT CMD_GridSpatialRepresentation_Type(CMD_GridSpatialRepresentation_Type const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_gmd_ALTOVA_CMD_GridSpatialRepresentation_Type

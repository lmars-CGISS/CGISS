#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CdateTime
#define _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CdateTime
...
{
public:
	gie_EXPORT CdateTime(xercesc::DOMNode* const& init);
	gie_EXPORT CdateTime(CdateTime const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CdateTime

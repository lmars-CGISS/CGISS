#ifndef _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CpositiveInteger
#define _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CpositiveInteger
...
{
public:
	gie_EXPORT CpositiveInteger(xercesc::DOMNode* const& init);
	gie_EXPORT CpositiveInteger(CpositiveInteger const& init);
...
#endif // _ALTOVA_INCLUDED_gie_ALTOVA_xs_ALTOVA_CpositiveInteger

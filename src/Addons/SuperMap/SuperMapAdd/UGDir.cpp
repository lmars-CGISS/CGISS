...
bool UGDir::CreateDir(const string& strPath)
{
	string strAbsolutePath = strPath;
	wchar_t* szPath= SuAddonBase::CharToWchar(strAbsolutePath.data());
...
{	
	...
	wchar_t* wcFind = SuAddonBase::CharToWchar(strFinds.data());
...
int UGDir::GetSubPaths(std::vector<string>& vPathNames, const string& strPath)
{
	return GetSubPaths(vPathNames, strPath, "*", false);
}

int UGDir::GetSubPaths(std::vector<string>& vPathNames, const string& strPath, const string& strNameFilter)
{
	return GetSubPaths(vPathNames, strPath, strNameFilter, false);
}

int UGDir::GetSubPaths(std::vector<string>& vPathNames, const string& strPath, const string& strNameFilter, bool bRecursive)
{
...
int UGDir::GetFiles(std::vector<string>& vFileNames, const string& strPath)
{
	return GetFiles(vFileNames, strPath, "*", false);
}

int UGDir::GetFiles(std::vector<string>& vFileNames, const string& strPath, const string& strNameFilter)
{
	return GetFiles(vFileNames, strPath, strNameFilter, false);
}

int UGDir::GetFiles(std::vector<string>& vFileNames, const string& strPath, const string& strNameFilter, bool bRecursive)
{
...
int UGDir::GetDirectories(std::vector<string>& vDirNames, const string& strPath)
{
	return GetDirectories(vDirNames, strPath, "*", false);
}

int UGDir::GetDirectories(std::vector<string>& vDirNames, const string& strPath, const string& strNameFilter)
{
	return GetDirectories(vDirNames, strPath, strNameFilter, false	);
}

int UGDir::GetDirectories(std::vector<string>& vDirNames, const string& strPath, const string& strNameFilter, bool bRecursive)
{

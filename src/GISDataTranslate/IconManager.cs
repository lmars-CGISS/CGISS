...
namespace GISDataTranslate
{
    ...
    /// 图标管理
    /// </summary>
    class IconManager:Dictionary<string,System.Drawing.Image>
    {
        System.IO.DirectoryInfo m_Path;
        public IconManager(Config config)
            : base(System.StringComparer.OrdinalIgnoreCase)
        {
            GConfig.GlobalConfig.Icons = this;
            string str = config["IconFolder"].StringValue(@"..\Res");
            if (!System.IO.Path.IsPathRooted(str))
                str = System.IO.Path.GetFullPath(str);
            m_Path = new System.IO.DirectoryInfo(str);
        }
        ...
        public System.Drawing.Image LoadIcon(string strKey)
        {
            ...
            foreach (var item in m_Path.GetFiles(strKey + ".*"))
            {
        ...
        public System.Drawing.Icon GetFileIcon(string name, IconSize size, bool linkOverlay)
        {
		...
		/// <returns>System.Drawing.Icon</returns>
		public System.Drawing.Icon GetFolderIcon( IconSize size, FolderType folderType )
		{

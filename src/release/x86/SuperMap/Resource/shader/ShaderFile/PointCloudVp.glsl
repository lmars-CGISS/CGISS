...
void main(void)
{
	...
	gl_FrontColor = mixColor * gl_Color;
	vec4SelectionColor = vec4(1.0, 1.0, 1.0, 1.0);
	vertexPos.w = 1.0;

	if(hasSelection > 0.2 && vec4SelectionColor.a > 0.0 && gl_SecondaryColor.r < 0.99 && gl_SecondaryColor.g < 0.99 && gl_SecondaryColor.b < 0.99 && gl_SecondaryColor.a < 0.99)
	{
